...
if(!empty($_SESSION["produtos"])) {
    foreach($_SESSION["produtos"] as $key => $produto) {
        ...
        <tr>
            ...
            <td style="border:1px solid black"><img src="imagens/'.$product["productImage"].'" width="100"></td>
            <td style="border:1px solid black">'.$product["product"].'</td>
            <td style="border:1px solid black">'.$product["productPrice"].'</td>
            <td style="border:1px solid black">'.$product["productDescription"].'</td>
            <td style="border:1px solid black">'.$product["productmarca"].'</td>
        </tr>
        ';
    }
} else {
