...
if(!empty($_SESSION["fornecedores"])) {
    foreach($_SESSION["fornecedores"] as $key => $client) {
...
<body>
    ...
    <p style="text-align:center">Total de fornecedorees: '.count($_SESSION["fornecedores"]).'</p>
    <table>
        <thead>
            <tr>
                <th style="background:gray;font-weight:bold" scope="col">#</th>
                <th style="background:gray;font-weight:bold;" scope="col">Imagem</th>
                <th style="background:gray;font-weight:bold;width:300px" scope="col">Razão Social</th>
                <th style="background:gray;font-weight:bold;width:100px" scope="col">CNPJ</th>
                <th style="background:gray;font-weight:bold;width:150px" scope="col">Telefone</th>
                <th style="background:gray;font-weight:bold;width:250px" scope="col">Email</th>
            </tr>
        </thead>
